...
description: "A difference-in-differences study of 147 Phoenix-area zip codes from 2010-2020, and a demonstration of how the original specification produced a false positive."
...
affected" are genuinely different kinds of places. Control zips are suburban areas
...
dollars, and projected a counterfactual, or what the affected zip codes *would* have
been worth had the routes never changed, and then read the damage off the gap between
the two lines:
...
The gap only opens from year +3 onward (from 2017). This coincides with
